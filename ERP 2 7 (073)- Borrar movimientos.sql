...
-- Borra los movimientos del ERP 2.7.073
...
delete from ERP_DET_CUP_LIQ_FIN
delete from ERP_DET_CUP_LIQ_TAR
delete from ERP_DET_GAS_LIQ_FIN
...
delete from ERP_DEV_IVA_CUO
delete from ERP_EQU_PMP 
...
delete from ERP_GEN_DEV_IVA_CUO
...
delete from ERP_LIQ_FINANCIERAS
...
delete from ERP_PMP
delete from ERP_PRO_RTA_EMB_ARBA
...
delete from ERP_RES_EMB_ARBA
delete from ERP_RES_RIS_SUC
...
delete from ERP_SIM_PLA_ART 
delete from ERP_SIM_PLA_CAB 
delete from ERP_SIT_PAT
delete from ERP_TIC_CAM_EMI
delete from ERP_TMP_SUB_PRO
...
delete from ERP_ARM_COM_DIN
delete from ERP_ART_CAN_LIS
...
delete from ERP_DET_ARM_COM_DIN
delete from ERP_DET_ART_BON
delete from ERP_DET_BON
delete from ERP_DET_COMBOS
delete from ERP_DET_COMBO_AGR
delete from ERP_DET_COMBO_ART
delete from ERP_DET_CUE_CAJ
delete from ERP_DET_EMB
delete from ERP_DET_FOR
delete from ERP_DET_FOR_EQUIPOS
delete from ERP_DET_INDICES
delete from ERP_DET_LIB
delete from ERP_DET_PRO
delete from ERP_DET_RTA
